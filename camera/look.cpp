...
int main() {
	...
	glBindTexture(GL_TEXTURE_2D, texture2);
        ...
        float radius = 10.0f;
        float angleX = sin(glfwGetTime()) * radius;
        float angleZ = cos(glfwGetTime()) * radius;
        glm::mat4 view = glm::mat4(1.0f);
        view = glm::lookAt(glm::vec3(angleX, 0.0f, angleZ), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
